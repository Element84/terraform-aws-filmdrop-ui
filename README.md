...
| <a name="input_filmdrop_ui_config"></a> [filmdrop\_ui\_config](#input\_filmdrop\_ui\_config) | FilmDrop UI Deployment Config File | `string` | n/a | yes |
| <a name="input_filmdrop_ui_logo"></a> [filmdrop\_ui\_logo](#input\_filmdrop\_ui\_logo) | The file contents of the supplied custom logo | `string` | n/a | yes |
